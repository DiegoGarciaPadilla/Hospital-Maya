<!-- 
    ...
    Esta página permite la navegación entre las demás páginas del sitio web,
    además de contener una indroducción de la misma
...
<html>
    ...
    <body>
        ...
        <section class="cuerpo2 altura">
            <h1 class="titulo">Hospital maya</h1>
            <hr>
            <br>
            <p style="font-size: 30px" id="lettering">"Donde quiera que se ama el arte de la medicina se ama también a la humanidad."</p>
            <img src="recursos/hospital.jpg"  alt="hospital"/>
        </section>
