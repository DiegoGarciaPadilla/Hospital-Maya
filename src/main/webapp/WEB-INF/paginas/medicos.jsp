<!-- 
    ...
    Esta página permite visualzar el contenido de la tabla 'medicos', agregar,
    ...
    <body>
        ...
        <section class="cuerpo altura">
            ...
            <table>
                ...
                <tbody>
                    <!-- Ciclo que se repite hasta ingresar todos los datos de la tabla 'medicos' -->
                    <c:forEach var="med" items="${medicos}">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/MedicosServlet?accion=editar&matricula=${med.matricula}">Editar</a></td>
                            <td><a href="${pageContext.request.contextPath}/MedicosServlet?accion=eliminar&matricula=${med.matricula}">Eliminar</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
            ...
            <div class="boton">
                <button onclick="window.location.href = '${pageContext.request.contextPath}/MedicosServlet?accion=agregar'">Registrar médico</button>
            </div>
